...
MissionCondition1 = [ "WIN", { TGT inArea baseTrg && MVP inArea baseTrg }, "All objectives done" ];
MissionCondition2 = [ "WIN_MVP", { !alive TGT && MVP inArea baseTrg }, "MVP rescued, TGT killed" ];
MissionCondition3 = [ "WIN_TGT", { TGT inArea baseTrg && !alive MVP }, "TGT extracted, MVP killed" ];
MissionCondition4 = [ "FAIL", { !alive TGT && !alive MVP && call fnc_CheckPlayersReturned}, "All objectives failed" ];
